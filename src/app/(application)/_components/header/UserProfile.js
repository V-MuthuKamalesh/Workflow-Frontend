      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-96 text-center relative">
        ...
        <div className="flex flex-col items-center space-y-4">
          {loading ? (
            ...
            <div className="w-24 h-24 rounded-full overflow-hidden bg-gray-300 flex items-center justify-center shadow">
              {userDetails?.picture ? (
                <Image
                  src={
                ...
                <span className="text-4xl text-white font-bold">{userDetails?.fullname?.charAt(0).toUpperCase()}</span>
              )}
            </div>
          )}
          ...
          {loading ? (
            <div className="h-4 w-48 bg-gray-300 animate-pulse rounded-md" />
          ) : (
          ...
          <button
            className="w-full border border-red-500 text-red-500 font-medium py-2 rounded-md hover:bg-red-50"
