...
export default function NotificationsModal({
  ...
  return (
    <div
      className={`fixed right-0 top-16 w-[30rem] rounded-l-3xl bg-zinc-800 text-white shadow-lg h-full z-50 p-5 overflow-y-auto transition-transform duration-700 ease-in-out transform ${
            ...
            {notifications.map((notification) => (
              <li
                ...
                className={`p-3 rounded-md shadow-sm border text-gray-200 ${
                  notification.status === "Unread" ? bgColor : "bg-gray-700 border-gray-500"
                }`}
              >
