...
export default function WorkspaceMembers({ isAdmin, module, workspaceId, members }) {
    ...
    <div className="mt-6 p-4 bg-white shadow-md rounded-md">
      ...
      <ul className="space-y-2">
        {groupedMembers[activeTab].map((member, index) => (
          ...
          >
            <div className="flex-shrink-0 w-8 h-8 bg-blue-100 text-purple-500 rounded-full flex items-center justify-center font-medium">
